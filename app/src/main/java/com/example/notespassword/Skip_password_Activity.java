...
public class Skip_password_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skip_password);
        getSupportActionBar().setTitle("Password");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        button = findViewById(R.id.btn_skip_generate_password);
        phint = findViewById(R.id.txt_skip_hint_password);
